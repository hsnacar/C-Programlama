...
* ne işe yarıyor: Tanım dışında kullanıldığında bellek adresindeki veriye ulaşmamızı sağlar.
...
Yeniden kodları izah etmek gerekirse:
    ...
    5. satır: rakam'ın hafıza adresini bellek'e atadık.
    6. satır: *bellek ile adresteki veriye ulaşıp ekrana yazdırdık.

19. derste "5"i depolayan hafıza kümesine ulaşmak için elimizde iki araç var demiştik.
...
20. dersin sonunda size önerim: 
1'den 20'ye kadar birkaç defa tekrar yapın. 
Kodları hiçbir yere bakmadan kendiniz yazmaya çalışın.
