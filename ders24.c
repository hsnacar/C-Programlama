...
int main(void){
    ...
    printf("dizi adresi %u \n", dizi);
    printf("dizi[0] adresi %u \n", &dizi[0]);
    printf("dizi[1] adresi %u \n", &dizi[1]);
    printf("dizi[2] adresi %u \n", &dizi[2]);
    printf("dizi[2] adresi %u \n", &dizi[3]);
...
Hafıza (ram yani read access memory) 1byte'lık bölümlere ayrılmıştır.
...
Mesela int türünde dizi[10] deseydik 4x10 toplam 40byte'lık bir alan bu array'e ayrılacaktı.
